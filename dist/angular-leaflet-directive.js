/*!
*  angular-leaflet-directive 0.8.4 2015-10-07
...
angular.module("leaflet-directive").directive('paths', ["$log", "$q", "leafletData", "leafletMapDefaults", "leafletHelpers", "leafletPathsHelpers", "leafletEvents", "leafletWatchHelpers", function ($log, $q, leafletData, leafletMapDefaults, leafletHelpers, leafletPathsHelpers, leafletEvents, leafletWatchHelpers) {
    return {
        restrict: "A",
        scope: false,
        replace: false,
